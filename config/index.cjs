...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxf59665c7433a3eae',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'd22d02990c0bf3e10d4b5329809dcc74',
  ...
  USERS: [biubiubiu
    {
      ...
      id: 'o7Bog5gg7YfwFZdngwJE143Gzjnw',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'EiDr7hBmYqvzneSKdgCIPNvATtJ7F5iyjyUQ85bpJuY',
      // 所在省份
      province: '浙江',
      // 所在城市
      city: '杭州',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '宝贝', year: '2002', date: '02-07',
        },
        {
          type: '节日', name: '恋爱纪念日', year: '2019', date: '02-07',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2019-02-07' },
        // 恋爱纪念日
        { keyword: 'marry_day', date: '2019-02-07' },
